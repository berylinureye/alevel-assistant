...
def test_fast_batch_defaults_are_quality_first() -> None:
    assert pipeline_module.FAST_BATCH_PREPARE_MAX_WORKERS == 10
    assert pipeline_module.FAST_BATCH_MAX_WORKERS == 16
    assert pipeline_module.FAST_BATCH_PREPARE_TIMEOUT_SECONDS == 120
    assert pipeline_module.FAST_BATCH_QUESTION_TIMEOUT_SECONDS == 120
    assert pipeline_module.FAST_BATCH_AFTER_FIRST_QUESTION_TIMEOUT_SECONDS == 25
